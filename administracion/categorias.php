                ...
                <div class="col-sm-7">
                    <div class="row">
                        <div class="col-md-4 has-feedback has-feedback">
                            <input type="text" class="form-control" placeholder="Ingrese el Nombre" name="nom" required>
							<select data-placeholder="Tipo" class="select" name="tip" required>
								<option selected value=""></option>
								<option value="1">Oficio</option>
								<option value="2">Profesional</option>
							</select>
                            <input type="hidden" id="fn" name="fn" value="cat_a"/>
            	...
            	<div class="col-md-6">
                	...
                	<div class="tab-pane active fade in" id="inside">     
			            ...
			            <div class="panel panel-default">
			                <div class="panel-heading"><h6 class="panel-title"><i class="icon-table"></i> Categorias </h6></div>
                            ...
                            <div class="table">
				                <table class="table">
                            		...
                            		$query="SELECT * FROM categorias WHERE baja = 0";
				                    ...
				                    <tbody>
				                        <tr>
											...
											<td><?PHP if ($nn["tipo"]==1){ echo "Oficio"; }else{ echo "Profesion"; }  ?></td>
				                            <td>
                                            <div class="table-controls">
                                                <a href="editar_datos.php?id=<?PHP echo $nn['id'];?>&nombre=<?PHP echo $nn['nombre'];?>&tipo=<?PHP echo $nn['tipo'];?>&fn=cat_u"
