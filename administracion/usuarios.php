		...
		<!-- Page content -->
	 	<div class="page-content">
			...
			<div class="form-group">
                <label class="col-sm-2 control-label">Nuevo Usuario: </label>
                <div class="col-sm-10">
                    <div class="row">
                        <div class="col-sm-3 has-feedback has-feedback">
                            <input type="text" class="form-control" placeholder="Ingrese el Nombre" name="usuario" onkeyup="javascript:this.value=this.value.toUpperCase();" required>
                            <input type="hidden" id="fn" name="fn" value="ctrl"/>                           
                        </div>
				                        ...
				                        <tr>
				                            ...
				                            <td>
												...
												<div class="table-controls">
													...
													$nm=$us["nombre"];
													?>
													<a href="usuarios_datos.php?id=<?PHP echo $id;?>&usuario=<?PHP echo $usu;?>&nombre=<?PHP echo $nm;?>&fn=udp"
													class="btn btn-success btn-icon btn-xs tip" title="Editar / Eliminar">&nbsp;&nbsp;Editar&nbsp;&nbsp;</a>
												</div>
												<?PHP } ?>
                                            </td>
                                            <td>
												<?PHP if($us["admin"]==0){?>
												<div class="table-controls">
													<a href="usuarios_psw.php?id=<?PHP echo $id;?>&usuario=<?PHP echo $usu;?>&nombre=<?PHP echo $nm;?>fn=psw"
													class="btn btn-success btn-icon btn-xs tip" title="Cambiar Contrase&ntilde;a"> Cambiar Contrase&ntilde;a </a>
												</div>
												<?PHP } ?>
                                            </td>
				                        </tr>
