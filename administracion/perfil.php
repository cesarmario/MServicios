...
<title>OVERCOMING Administración</title>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>OVERCOMING Administración <small>Perfil de Usuario</small></h3>
				</div>
			</div>
			<!-- /page header -->

        	<!-- Form components -->
    		<form class="form-horizontal" role="form" action="usuarios_psw.php" method="GET">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-2 has-feedback has-feedback-left">
										...
										value="<?PHP echo $_SESSION['sesion_UserId'];?>" name="id_usu" disabled >
										<i class="icon icon-user3 form-control-feedback"></i>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-4 has-feedback has-feedback-left">
										...
										value="<?PHP echo $_SESSION['sesion_UserNom'];?>" name="id_usu" disabled >
										<i class="icon icon-user4 form-control-feedback"></i>
									</div>
								</div>
							</div>
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-4 has-feedback has-feedback-left">
										<input type="hidden" id="id" name="id" value="<?PHP echo $_SESSION['sesion_UserRow'];?>"/>
										<input type="hidden" id="usuario" name="usuario" value="<?PHP echo $_SESSION['sesion_UserId'];?>"/>
										<input type="hidden" id="fn" name="fn" value="psw"/>
										<input type="submit" value="Cambiar Contrase&ntilde;a" class="btn btn-danger">
									</div>
								</div>
							</div>
