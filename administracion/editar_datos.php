 	...
 	<div class="page-container">
		...
		<!-- Page content -->
	 	<div class="page-content">
        	...
        	<!-- Form components -->
    		<form class="form-horizontal" role="form" action="funciones/rubros.php" method="GET">
							...
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-6 has-feedback has-feedback">                                    	
										<input type="text" class="form-control" value="<?PHP echo $_GET[nombre];?>" name="nom" required>
									</div>
								</div>
							</div>
						</div>
