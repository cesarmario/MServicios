			...
			<div class="sidebar-content">
					...
					<div class="popup dropdown-menu dropdown-menu-right">
                        <div class="thumbnail">
                            <div class="caption text-center">
                                <h6><?PHP echo $_SESSION['sesion_ProfNom'];?> <small>Matricula: <?PHP 
								echo $_SESSION['sesion_ProfMat'];?></small></h6>                                
                            </div>
                        </div>
                        <ul class="list-group">
				...
				<ul class="navigation">
					...
					<li>
						...
						<ul>
                        	<li class="active"><a href="#">Eliminar Cirug&iacute;a</a></li>
	 	...
	 	<div class="page-content">
			...
			<div class="page-header">
				<div class="page-title">
					<h3>Cirug&iacute;as <small>Baja</small></h3>
				</div>
			</div>
			<!-- /page header -->
		        ...
		        <div class="panel panel-default">
	                <div class="panel-body">
                        ...
                        <div class="form-group">
							<label class="col-sm-2 control-label">Bono N&uacute;mero: </label>
							<div class="col-sm-10">
								<div class="row">
									<div class="col-sm-2">
